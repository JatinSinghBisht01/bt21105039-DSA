...
/*
For a n sized array the time complexity to traverse it will be O(n)
 whereas for a n nodes Balanced Binary treethe Time complexity will be O(height of BST) == O(logn);
*/
